...
namespace Hexa.NET.Raylib
{
	...
	public enum RlTextureFilter : int
	{
		...
		/// Linear filtering<br/>
		/// </summary>
		[NativeName(NativeNameType.EnumItem, "RL_TEXTURE_FILTER_BILINEAR")]
		...
		/// </summary>
		[NativeName(NativeNameType.EnumItem, "RL_TEXTURE_FILTER_TRILINEAR")]
		...
		/// </summary>
		[NativeName(NativeNameType.EnumItem, "RL_TEXTURE_FILTER_ANISOTROPIC_4X")]
		...
		/// </summary>
		[NativeName(NativeNameType.EnumItem, "RL_TEXTURE_FILTER_ANISOTROPIC_8X")]
		...
		/// </summary>
		[NativeName(NativeNameType.EnumItem, "RL_TEXTURE_FILTER_ANISOTROPIC_16X")]
